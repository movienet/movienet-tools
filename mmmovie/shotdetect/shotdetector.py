...
# Select detectors:
from mmmovie.shotdetect.shotdetect.detectors.content_detector_hsv_luv import \
    ContentDetectorHSVLUV
from mmmovie.shotdetect.shotdetect.keyf_img_saver import (generate_images,
                                                          generate_images_txt)
from mmmovie.shotdetect.shotdetect.shot_manager import ShotManager
# For caching detection metrics and saving/loading to a stats file
from mmmovie.shotdetect.shotdetect.stats_manager import StatsManager
# Standard PyshotDetect imports:
from mmmovie.shotdetect.shotdetect.video_manager import VideoManager
# Tools
from mmmovie.shotdetect.shotdetect.video_splitter import split_video_ffmpeg


class ShotDetector(object):
    """Shot detector class with options.
        print_list (bool): Whether to print detect shot list out.
        keep_resolution (bool): Whether to keep resolution in the process of shot detect
        save_keyf (bool): Whether to save key frame image.
        save_keyf_txt (bool): Whether to save key frame image index.
        split_video (bool): Whether to split shot video out.
        begin_time/end_time (float): Set up duration time.
        begin_frame/end_frame (int): Set up duration frame.
    ...
    """
    def __init__(self, print_list=False, keep_resolution=False,
                 save_keyf=False, save_keyf_txt=False, split_video=False,
                 begin_time=None, end_time=100.0, begin_frame=None, end_frame=1000):
