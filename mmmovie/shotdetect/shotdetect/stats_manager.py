...
from mmmovie.shotdetect.shotdetect.frame_timecode import MINIMUM_FRAMES_PER_SECOND_FLOAT
from mmmovie.shotdetect.shotdetect.platform import get_csv_reader
...
class NoMetricsRegistered(Exception):
    ...
    to the owning shotManager object, if any). """
    pass
...
class NoMetricsSet(Exception):
    ...
    detect_shots(...) was not called on the owning shotManager object, if any. """
    pass
