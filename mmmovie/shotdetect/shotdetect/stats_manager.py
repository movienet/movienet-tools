...
class FrameMetricNotRegistered(Exception):
    ...
    def __init__(
        self,
        metric_key,
        message='Attempted to get/set frame metrics for unregistered metric key.'
    ):
        # type: (str, str)
        # Pass message string to base Exception class.
...
class StatsFileCorrupt(Exception):
    ...
    def __init__(
        self,
        message='Could not load frame metric data data from passed CSV file.'):
        # type: (str, str)
        # Pass message string to base Exception class.
...
class StatsFileFramerateMismatch(Exception):
    ...
    def __init__(
        ...
        base_timecode_fps,
        stats_file_fps,
        message='Framerate differs between stats file and base timecode.'):
        # type: (str, str)
        # Pass message string to base Exception class.
